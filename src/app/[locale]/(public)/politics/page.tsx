...
import PoliticsTabNav, { type PoliticsTab } from '@/components/politics/PoliticsTabNav';
...
const VALID_TABS: PoliticsTab[] = ['factions', 'parties', 'groups', 'timeline', 'graph'];

interface Props {
  searchParams: Promise<{ tab?: string; knesset?: string; search?: string; type?: string }>;
}
