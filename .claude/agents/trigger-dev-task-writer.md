...
> **Before starting any task, read the latest rules from:**
>
> - `.github/instructions/trigger-basic.instructions.md`
> - `.github/instructions/trigger-advanced-tasks.instructions.md`
> - `.github/instructions/trigger-config.instructions.md`
> - `.github/instructions/trigger-scheduled-tasks.instructions.md`
